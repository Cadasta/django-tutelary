...
def test_collective(datadir, setup):  # noqa
    ...
    assert not user1.has_perm('parcel.view', parcel1)
    assert not user1.has_perm('parcel.list', proj1)
    assert user2.has_perm('parcel.view', parcel1)
    assert user2.has_perm('parcel.list', proj1)
    assert user3.has_perm('parcel.view', parcel1)
    assert user3.has_perm('parcel.list', proj1)

    parcel2 = Object('parcel/Cadasta/Proj2/114')
    proj2 = Object('project/Cadasta/Proj2')
    assert not user1.has_perm('parcel.view', parcel2)
    assert not user1.has_perm('parcel.list', proj2)
    assert user2.has_perm('parcel.view', parcel2)
    assert user2.has_perm('parcel.list', proj2)
    assert user3.has_perm('parcel.view', parcel2)
    ...
    assert not user1.has_perm('parcel.view', parcel3)
    assert not user1.has_perm('parcel.list', proj3)
    assert not user2.has_perm('parcel.view', parcel3)
    assert not user2.has_perm('parcel.list', proj3)
    assert not user3.has_perm('parcel.view', parcel3)
